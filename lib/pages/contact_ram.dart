...
class ContactRam extends StatefulWidget {
  const ContactRam({super.key});

  @override
  State<ContactRam> createState() => _ContactState();
}

class _ContactState extends State<ContactRam> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(
      appBar: AppBar(
        title: const Text("Commentaire Ramasseur", style: TextStyle(color: Color(0xFF188C74)),),
